...
public class BillingServicesImpl implements BillingServices {
   ...
   BillDao billDao;
	...
	public Plan getPlanAllDetails(int planId)throws PlanDetailsNotFoundException {
		return planDao.findById(planId).orElseThrow(()->new PlanDetailsNotFoundException("Plan Not Present with Id="+planId));		
	}
	...
	public Customer getCustomerDetails(int customerID) throws CustomerDetailsNotFoundException {
		 return customerDao.findById(customerID).orElseThrow(()->new CustomerDetailsNotFoundException("Customer not present with ID="+customerID));
	}
	...
	public PostpaidAccount getPostPaidAccountDetails(int customerID, long mobileNo)
		...
		return postpaidAccountDao.findById(mobileNo).orElseThrow(()-> new PostpaidAccountNotFoundException("Account not present with mobileNo="+mobileNo));
	}
